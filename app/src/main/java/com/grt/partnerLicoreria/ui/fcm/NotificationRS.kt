package com.grt.partnerLicoreria.ui.fcm

import android.util.Log
import com.android.volley.AuthFailureError
import com.android.volley.Response
import com.android.volley.toolbox.JsonObjectRequest
import com.grt.partnerLicoreria.common.PartnerLicoreriaApplication
...
class NotificationRS {
    fun sendNotification(title: String, message: String, tokens: String){
        ...
        PartnerLicoreriaApplication.volleyHelper.addToRequestQueue(jsonObjectRequest)
    }
